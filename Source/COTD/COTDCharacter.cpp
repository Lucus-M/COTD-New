...
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ACOTDCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ACOTDCharacter::Look);
	}
	else
	{
...
void ACOTDCharacter::TakeDamage(float DamageAmount)
{
	...
	UE_LOG(LogTemplateCharacter, Warning, TEXT("Player Health: %f"), Health);
